...
def main():
    ...
    inputFile = "CS170_Small_Data__11.txt"
    # inputFile = "CS170_Large_Data__12.txt"
    ...
    while (menuOn):
        ...
        if choice == 1:
            print(f"\nThis dataset has {numColumns-1} features (not including the class), with {numRows} instances.\n")
            start_time = time.time()
